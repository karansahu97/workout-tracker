...
const supabaseUrl = import.meta.env.VITE_SUPABASE_URL || (typeof window !== 'undefined' ? `${window.location.origin}/supabase-api` : 'https://dactaumlwvhctogkejul.supabase.co')
